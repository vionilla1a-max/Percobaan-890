...
Tambah Transaksi dengan mengisi nominal, kategori, dan tanggal.
Atur Budget bulanan melalui menu anggaran.
Tinjau Analisis untuk melihat pola pengeluaran.
Gunakan Menu Pengaturan untuk mengelola kategori, limit, dan data.
Aktifkan Sinkronisasi GitHub untuk menyimpan dan mengakses data di berbagai perangkat.
